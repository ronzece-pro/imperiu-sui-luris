    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white bg-opacity-10 backdrop-blur-lg border border-slate-700 rounded-2xl p-8">
          ...
          <p className="text-gray-400 text-center mb-8">Devino cetățean al Imperiul Sui Juris</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-gray-300 text-sm font-medium mb-2">Cod de invitație</label>
              <input
                type="text"
                name="inviteCode"
