...
const marketplaceItems = [
  {
    ...
    type: "document",
    name: "State Bulletin",
    description: "Official bulletin of Imperiu Sui Luris - proof of citizenship",
    price: 10,
    currency: "credits",
  ...
  },
  {
    ...
    type: "document",
    name: "State Passport",
    description: "Official passport for citizens of Imperiu Sui Luris - valid for 10 years",
    price: 50,
    currency: "credits",
